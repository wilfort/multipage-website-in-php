...
<body>
    ...
    <section>
                ...
                <div class="row">
                    <div class="col-xs-0 col-sm-1 col-md-2 col-lg-3 line">

                    </div>
                    <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6">
                        <h1 class="main_header customColor">Nous avons besoin de dons pour vivre.</h1>
                    </div>
                    <div class="col-xs-0 col-sm-1 col-md-2 col-lg-3 line">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        Vous avez envie de faire un don à une association ? Un projet qui a du sens, qui poursuit une mission auprès des jeunes, qui les pousse à réfléchir et qui favorise leur ouverture d’esprit ? Les dons faits à la Fondation donnent droit à une attestation fiscale à partir de € 40 (art. 145/33 CIR).
                    </div>
                    <div class="col-xs-12">
                    ...
                    <div class="col-xs-12">
                        <ul>
                            <li>
                                Vos dons peuvent  être versés sur notre projet « <a href="http://www.bonnescauses.be/organisation/?id=0884345931&SearchTerm=odyssea%20asbl&autoSuggestWasUsed=5955,fr&Citydistance=5">Odyssea asbl</a> » (Site de la Fondation Roi Baudoin) jusqu’au 30/03/18. C’est la Fondation Roi Baudouin qui vous fournira l’attestation fiscale dont vous aurez besoin pour votre déductibilité.
                            </li>
                            <li>
                                Les dons pour le projet peuvent être versés jusqu’au 30/03/18 au compte IBAN BE10 0000 0000 0404 – BIC: BPOTBEB1 de la Fondation Roi Baudouin avec la mention obligatoire ‘128/2887/00017’.
                            </li>
                        </ul>
                    </div>
                    <div class="col-xs-12">
